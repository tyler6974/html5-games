...
<tileset version="1.4" tiledversion="1.4.2" name="T32" tilewidth="32" tileheight="32" tilecount="256" columns="16">
 <image source="tiles32.png" width="512" height="512"/>
 <tile id="1" type="playerWheelGoing">
  <animation>
   <frame tileid="1" duration="50"/>
   <frame tileid="2" duration="50"/>
  </animation>
 </tile>
 <tile id="3" type="playerWheelStopped"/>
 <tile id="4" type="playerWheelStarting">
  <animation>
 ...
 <tile id="8" type="playerWheelSmoke">
  <animation>
 ...
 <tile id="40" type="playerProjectile">
  <animation>
 ...
 <tile id="74" type="playerProjectileUp">
  <animation>
   <frame tileid="74" duration="50"/>
   <frame tileid="75" duration="50"/>
   <frame tileid="76" duration="50"/>
   <frame tileid="77" duration="50"/>
   <frame tileid="78" duration="50"/>
  </animation>
 </tile>
 <tile id="81" type="groundDrone2">
  <animation>
 ...
 <tile id="90" type="playerProjectile45deg">
  <animation>
   <frame tileid="90" duration="50"/>
   <frame tileid="91" duration="50"/>
   <frame tileid="92" duration="50"/>
   <frame tileid="93" duration="50"/>
   <frame tileid="94" duration="50"/>
  </animation>
 </tile>
 <tile id="96" type="railStopSign"/>
 <tile id="101" type="tonyFrontIdle">
  <animation>
 ...
 <tile id="106" type="playerProjectileForward">
  <animation>
 ...
 <tile id="122" type="playerProjectileHit">
  <animation>
 ...
 <tile id="192" type="drone1ProjectileHit">
  <animation>
 ...
 <tile id="208" type="drone2Projectile">
  <animation>
 ...
 <tile id="212" type="drone2ProjectileHit">
  <animation>
